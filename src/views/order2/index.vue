    ...
    <el-card class="box-card">
      <el-form :inline="true" :model="search" class="demo-form-inline">
        ...
        <el-form-item label="是否可重复">
          <el-radio v-model="search.isRecordMultiple" label="0">否</el-radio>
          <el-radio v-model="search.isRecordMultiple" label="1">是</el-radio>
        </el-form-item>
        ...
        <el-form-item>
          <el-upload
            ref="upload"
            class="upload-demo"
            action="http://hibeau.vitarealm.cn/Upload/UploadResource"
            :data="data"
            :headers="headers"
            multiple
            :limit="1"
          ...
          >
            ...
            <el-button size="medium" type="primary" @click="setType(11,1)">天猫UCS</el-button>
            <el-button size="medium" type="primary" @click="setType(12,1)">天猫AVA</el-button>
            ...
            <el-button size="medium" type="primary" @click="setType(13,1)">贝贝网</el-button>
          </el-upload>
        </el-form-item>
      </el-form>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    setType(a, b, c) {
      ...
      this.data.type = a
      this.isPointPrice = b
      // if (a == 1 || a == 2 || a == 8 || a == 11 || a == 12 || a == 6 || a == 3) {
      //   this.isGiving = 1
      // } else {
      //   this.isGiving = 0
      // }
    ...
    async exportOrder() {
      ...
      axios({
        // 用axios发送post请求
        method: 'post',
        url: 'http://hibeau.vitarealm.cn/order/ExportPrudcutStatistics', // 请求地址
        data: data, // 参数
    ...
    async exportData() {
      ...
      axios({
        // 用axios发送post请求
        method: 'post',
        url: 'http://hibeau.vitarealm.cn/order/Export', // 请求地址
        data: data, // 参数
        responseType: 'blob', // 表明返回服务器返回的数据类型
        headers: {
          Authorization: getToken()
    ...
    async ImportData(url) {
      ...
      this.search.isRecordMultiple == '1' ? (data.isRecordMultiple = 1) : ''
